...
const OurStoryElite = () => {
  return (
    <section className="relative bg-[#1C1C1C] text-[#FFFFFF] px-6 md:px-12 lg:px-20 py-10 overflow-hidden font-[Poppins]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start relative z-10">
        ...
        <div className="flex flex-col justify-start">
          ...
          {/* Content */}
          <p className="mt-4 text-base md:text-lg leading-relaxed text-[#D9D9D9]">
        ...
        <div className="flex flex-col">
          ...
          />
          <p className="mt-4 text-sm md:text-base italic text-[#D9D9D9]">
      ...
      {/* Divider */}
      <div className="border-t border-[#D9D9D9]/30 mt-12 relative z-10"></div>

      {/* Bottom Stats */}
      <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-[#D9D9D9]/20 text-center mt-12 relative z-10">
        <div className="py-6 px-6 backdrop-blur-md bg-[#1C1C1C]/50 rounded-xl mx-4 mb-4 sm:mb-0">
          <h3 className="text-4xl md:text-5xl font-bold text-[#3CB371]">34+</h3>
          <p className="mt-2 text-sm md:text-base text-[#D9D9D9]">
        ...
        <div className="py-6 px-6 backdrop-blur-md bg-[#1C1C1C]/50 rounded-xl mx-4">
